...
import example.com.br.detectcardnumber.DetectEdges;
...
public class OverlayView extends View {
    ...
    //private final WeakReference<DetectEdges> mScanActivityRef;
    ...
    public OverlayView(Context context, AttributeSet attributeSet, boolean showTorch) {
        super(context, attributeSet);

        mShowTorch = showTorch;
        //mScanActivityRef = new WeakReference<DetectEdges>(captureActivity);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mDInfo != null) {
            ...
            if (mDInfo.numVisibleEdges() < 3) {
                ...
                canvas
                    .translate(mGuide.left + mGuide.width() / 2, mGuide.top + mGuide.height() / 2);
    ...
    public void markupCard() {
        ...
        float sf = mBitmap.getWidth() / (float) DetectEdges.CREDIT_CARD_TARGET_WIDTH;
